...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-574af523');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-574af523');}
...
var brandEl=document.querySelector('.rl-brand-574af523');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
